        ...
        <div class="nav-menu flex-row">
            ...
            <div class="collapse">
                <ul class="nav-items">
                    ...
                    <li class="nav-link">
                        <a href="guest_category.php" style="color: var(--secondary-color);">Category</a>
                    </li>
                    <li class="nav-link">
        ...
        <div class="container">
            ...
            <?php if ($categories && $categories->num_rows > 0): ?>
                <div class="category-filters">
                    <div class="category-filter <?= $active_category === null ? 'active' : '' ?>" onclick="window.location.href='guest_category.php'">
                    ...
                    <?php while ($category = $categories->fetch_assoc()): ?>
                        <div class="category-filter <?= $active_category == $category['id'] ? 'active' : '' ?>" 
                             onclick="window.location.href='guest_category.php?category=<?= $category['id'] ?>'">
