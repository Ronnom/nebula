                        ...
                        <div class="product-card">
                            ...
                            <div class="product-content">
                                ...
                                <div class="btn-container">
                                    <a href="guest_product_details.php?id=' . $product['id'] . '" class="btn btn-primary">View Details</a>
                                    <a href="../cart.php?id=' . $product['id'] . '" class="btn btn-secondary">Add to Cart</a>
                                </div>
                            </div>
                        </div>';
                    }
